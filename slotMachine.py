...
# Function to check the player's winnings
...
# Function for spinning the slot machine and checking winnings
def spin(balance):
    ...
    print(f"You are bedding RS {bet} on {lines} lines. Total bet is equal to: {total_bet}")
